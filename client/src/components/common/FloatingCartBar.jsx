...
const FloatingCartBar = () => {
  ...
  return (
    <div className="fixed bottom-3 inset-x-3 sm:inset-x-auto sm:right-6 sm:bottom-6 sm:w-[420px] z-50 animate-fade-in">
      <div className="bg-gradient-to-r from-stone-900 via-stone-950 to-stone-900 text-white rounded-2xl p-3 sm:p-3.5 shadow-2xl shadow-stone-950/40 border border-white/15 flex items-center justify-between gap-3 backdrop-blur-md">
        ...
        <div className="flex items-center space-x-3 min-w-0">
          <div className="relative shrink-0">
            ...
            <span className="absolute -top-1.5 -right-1.5 bg-rose-500 text-white text-[10px] font-extrabold w-5 h-5 rounded-full flex items-center justify-center border-2 border-stone-900 shadow-xs">
              {totalItems}
            </span>
          </div>
        ...
        <Link
          to="/cart"
          className="shrink-0 inline-flex items-center space-x-1.5 px-4 py-2.5 bg-rose-600 hover:bg-rose-500 active:scale-95 text-white text-xs sm:text-sm font-bold rounded-xl transition-all shadow-md shadow-rose-600/30"
        >
          <span>View Cart</span>
